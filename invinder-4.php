        ...
        <main class="canvas_cards">
            <div class="card informed">
                    ...
                    <div class="splide__track wh-100">
                        <ul class="splide__list wh-100">
                            <li class="splide__slide wh-100">
                                <img src="img/perfiles/4/photo1.png" class="wh-100">
                            </li>
                            <li class="splide__slide wh-100">
                                <img src="img/perfiles/4/photo2.png" class="wh-100">
                            </li>
                            <li class="splide__slide wh-100">
                                <img src="img/perfiles/4/photo3.png" class="wh-100">
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="card_content">
                    ...
                    <h2>Yola Red <span class="age">19 <img src="img/verified.png"></span></h2>
                    <ul>
                        <li>
                            <img src="img/cargo.png">
                            <p>Comunicativa y creativa</p>
                        </li>
                        <li>
                ...
                <div class="card_content_inside">
                    ...
                    <div class="w-100 tags">
                        <div class="tag" style="background:#30CEB3">
                            <img src="img/conexion.png">
                            <p>Administremos <b>tus redes sociales</b></p>
                        </div>
                    </div>
                </div>
                <div class="card_nav">
                    <a href="invinder-3.php" class="share" style="border-color:#EA2788;">
                        <img src="img/icon/share.png">
                    </a>
                    <a href="invinder-5.php" class="close" style="border-color:#3333CC">
                ...
                <div class="card_description absolute">
                    <h3>Yola Red <span class="age">19 <img src="img/verified.png"></span></h3>
                    <ul class="me">
                        <li>
                            <img src="img/cargo-blue.png">
                            <p>Comunicativa y creativa</p>
                    ...
                    <div class="w-100">
                        <div class="tag small" style="background:#30CEB3">
                            <img src="img/conexion.png">
                            <p>Administremos <b>tus redes sociales</b></p>
                        </div>
                    </div>
                    ...
                    <p>
                        Me gusta pasar tiempo en el celular, poniendo al día de todas las noticias y tendencias, también compartiendo mi día a día.
                    </p>
                    <div class="hr"></div>
                    <h4 style="color:#EA2788">Interéses</h4>
                    <ul class="languages dev">
                        <li>
                            <img src="img/perfiles/4/idiomas/i1.png">
                        </li>
                        <li>
                            <img src="img/perfiles/4/idiomas/i2.png">
                        </li>
                        <li>
                            <img src="img/perfiles/4/idiomas/i3.png">
                        </li>
                    </ul>
                </div>
            </div>
