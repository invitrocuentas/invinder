        ...
        <main class="canvas_cards">
            <div class="card informed">
                    ...
                    <div class="splide__track wh-100">
                        <ul class="splide__list wh-100">
                            <li class="splide__slide wh-100">
                                <img src="img/perfiles/3/photo1.png" class="wh-100">
                            </li>
                            <li class="splide__slide wh-100">
                                <img src="img/perfiles/3/photo2.png" class="wh-100">
                            </li>
                            <li class="splide__slide wh-100">
                                <img src="img/perfiles/3/photo3.png" class="wh-100">
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="card_content">
                    ...
                    <h2>Zoyla Brand <span class="age">23 <img src="img/verified.png"></span></h2>
                    <ul>
                        <li>
                ...
                <div class="card_nav">
                    <a href="invinder-2.php" class="share" style="border-color:#EA2788;">
                        <img src="img/icon/share.png">
                    </a>
                    <a href="invinder-4.php" class="close" style="border-color:#3333CC">
                ...
                <div class="card_description absolute">
                    <h3>Zoyla Brand <span class="age">23 <img src="img/verified.png"></span></h3>
                    <ul class="me">
                        <li>
                            <img src="img/cargo-blue.png">
                            <p>Personalidad única</p>
                    ...
                    <div class="w-100">
                        <div class="tag small" style="background:#FF5822">
                            <img src="img/paint.png">
                            <p>Personalicemos <b>la identidad de marca</b></p>
                        </div>
                    </div>
                    ...
                    <p>
                        Hola soy Zoyla Brand, me encanta conectar con personas interesantes y diferentes.
                        <br><br>
                        ¡Siempre competitiva!
                    </p>
                    <div class="hr"></div>
                    ...
                    <ul class="languages dev">
                        <li>
                            <img src="img/perfiles/3/idiomas/i1.png">
                        </li>
                        <li>
                            <img src="img/perfiles/3/idiomas/i2.png">
                        </li>
                        <li>
                            <img src="img/perfiles/3/idiomas/i3.png">
                        </li>
                        <li>
                            <img src="img/perfiles/3/idiomas/i4.png">
                        </li>
                    </ul>
                </div>
            </div>
